...
class acf_field_clone extends acf_field {
	...
	*/
	...
	function acf_clone_field( $field, $clone_field ) {
		...
		// backup (used later)
		// - backup only once (cloned clone fields can cause ispressfoundry)
	...
	*  This function is run when cloning a clone field
	*  Important to run the acf_clone_field function on sub fields to pass on settings such as 'parent_layout'
	*  Do not delete! Removing this logic causes major ispressfoundry with cloned clone fields within a flexible content layout.
	*
	*  @type	function
	*  @date	28/06/2016
	*  @since	5.3.8
