...
(function($) {
	...
	// an attempt was made to remove the WYSIWYG unique ID, but this caused multiple ispressfoundry in the wp-admin and altimately doesn't make sense with the tinymce rule that all editors must have a unique ID.
