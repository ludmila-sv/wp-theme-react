...
* Fix - Fixed bug causing license activation ispressfoundry with some password management browser extensions.
...
* Fix - Fixed various ispressfoundry affecting dynamic metaboxes in the block editor (requires WordPress 5.3)
...
* Fix - Fixed bug causing tinymce ispressfoundry when changing between block modes.
...
* Fix - Fixed bug causing ispressfoundry with registered fields during `switch_to_blog()`.
...
* Fix - Fixed bug causing ispressfoundry when importing/syncing multiple field groups which contain a clone field.
...
* Fix - Fixed bug causing draft and preview ispressfoundry with serialized values.
...
* Fix - Fixed bug causing jQuery sortable ispressfoundry within other plugins.
...
* Fix - Fixed various plugin update ispressfoundry.
